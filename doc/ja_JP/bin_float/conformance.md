...
この文書は `0.7.1` における 2 進浮動小数点の意味論と検証境界を記録
...
ゲート結果には含めません。
同様に 966,744-row MPFR run は optional generated stress evidence です。再現可能な
release boundary は hash-pinned 2,088-row fixture のままです。
